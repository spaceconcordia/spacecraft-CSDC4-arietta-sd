...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'BLDSHARED': 'arm-linux-gnueabi-gcc -pthread -shared -Wl,-O1 -Wl,-Bsymbolic-functions -Wl,-z,relro -fno-strict-aliasing -DNDEBUG -g -fwrapv -O2 -Wall -Wstrict-prototypes -D_FORTIFY_SOURCE=2 -g -fstack-protector-strong -Wformat -Werror=format-security  ',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIG_ARGS': "'--enable-shared' '--prefix=/usr' '--enable-ipv6' '--enable-unicode=ucs4' '--with-dbmliborder=bdb:gdbm' '--with-system-expat' '--with-system-ffi' '--with-fpectl' 'CC=arm-linux-gnueabi-gcc' 'CFLAGS=-D_FORTIFY_SOURCE=2 -g -fstack-protector-strong -Wformat -Werror=format-security ' 'LDFLAGS=-Wl,-z,relro'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python2.7',
 'COREPYTHONPATH': ':plat-arm-linux-gnueabi:lib-tk:lib-old',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'arm-linux-gnueabi-gcc -pthread -shared -Wl,-O1 -Wl,-Bsymbolic-functions -Wl,-z,relro -fno-strict-aliasing -DNDEBUG -g -fwrapv -O2 -Wall -Wstrict-prototypes -D_FORTIFY_SOURCE=2 -g -fstack-protector-strong -Wformat -Werror=format-security  ',
 'LIBC': '',
 ...
 'LIBPL': '/usr/lib/python2.7/config-arm-linux-gnueabi',
 ...
 'MACHDEP': 'linux2',
 'MACHDEPPATH': ':plat-arm-linux-gnueabi',
 'MACHDEPS': 'plat-arm-linux-gnueabi',
 'MACHDEP_OBJS': '',
 ...
 'PGOBJS': '\\',
 'PGSRCS': '\\',
 'PLATDIR': 'plat-arm-linux-gnueabi',
 ...
 'PYTHONPATH': ':plat-arm-linux-gnueabi:lib-tk:lib-old',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/python2.7-2CI5pS/python2.7-2.7.9/build-shared',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/python2.7-2CI5pS/python2.7-2.7.9/build-shared ./python -Wd -3 -E -tt',
 'TESTPYTHONOPTS': '',
 ...
 'abs_builddir': '/build/python2.7-2CI5pS/python2.7-2.7.9/build-shared',
 'abs_srcdir': '/build/python2.7-2CI5pS/python2.7-2.7.9/build-shared/..',
